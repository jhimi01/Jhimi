  ...
  return (
    ...
    >
      <div className="hero-grid" style={{ position: "relative" }}>
        ...
        <div className="hero-cell empty"></div>
        <div
          className="hero-cell hero-main-text"
        ...
        <div
          className="hero-cell vertical-text"
          onClick={() =>
            window.open(
              "https://www.linkedin.com/in/jhimi-talukder-801ab227b",
              "_blank",
            )
          }
          style={{ border: "none" }}
        ...
        <div className="hero-cell">
          ...
          >
            ...
            . Everyday I learn, read and practice to create the best interfaces
            as possible. It's beautiful to have a passion and a work at the same
        ...
        <div
          className="hero-cell vertical-text"
          onClick={() => window.open("https://github.com/jhimi01", "_blank")}
